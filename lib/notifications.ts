...
<body style="margin: 0; padding: 0; background: #f4f4f4; color: #111111;">
  <div style="max-width: 640px; margin: 0 auto; background: #ffffff; border-left: 1px solid #e5e5e5; border-right: 1px solid #e5e5e5;">
    ...
    <div style="background: #000000; padding: 8px 24px; text-align: center;">
      <p style="margin: 0; color: #ffffff; font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.2em; font-family: 'Satoshi', sans-serif;">THE ONYEAKỤKỌ INTELLIGENCE BRIEF</p>
    </div>

    <!-- Header -->
    <div style="padding: 48px 32px; text-align: left; border-bottom: 2px solid #000000; background: #ffffff;">
      <h1 style="margin: 0 0 8px 0; color: #000000; font-size: 42px; font-weight: 900; letter-spacing: -0.04em; text-transform: uppercase; font-family: 'Satoshi', sans-serif; line-height: 1;">ONYEAKỤKỌ</h1>
      <p style="margin: 0; color: #666666; font-size: 13px; text-transform: uppercase; letter-spacing: 0.1em; font-weight: 700; font-family: 'Satoshi', sans-serif;">Naija Digest &nbsp;//&nbsp; ${digestTime}</p>
    </div>
    
    <!-- Hero Article/Notice -->
    ${editorialNote ? `
    <div style="padding: 32px; background: #000000; color: #ffffff;">
    ...
    <div style="padding: 48px 32px; background: #f5f5f5; border-top: 1px solid #d1d1d1; text-align: left;">
      <div style="display: flex; align-items: flex-start; justify-content: flex-start;">
        ...
        <div style="margin-left: 16px;">
          <h3 style="margin: 0 0 4px 0; font-size: 16px; font-weight: 900; font-family: 'Satoshi', sans-serif; text-transform: uppercase; letter-spacing: 0.05em; color: #000000;">ONYEAKỤKỌ MEDIA</h3>
      ...
      <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e0e0e0; font-family: 'Satoshi', sans-serif;">
        <a href="https://onyeakuko.online" style="color: #000000; text-decoration: underline; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; margin-right: 16px;">Visit Website</a>
